export function GithubIcon({ className = 'w-5 h-5', ...rest }) {
  return (
    <svg
...
export function TwitterIcon({ className = 'w-5 h-5', ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 209"
...
export function LinkedInIcon({ className = 'w-5 h-5', ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
...
export function DribbbleIcon({ className = 'w-5 h-5', ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
